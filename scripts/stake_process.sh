...
# near call $exchange_contract_id mft_transfer_call '{"token_id": ":'$pool_id'", "receiver_id": "'$CONTRACT_NAME'", "amount": "263471303349847649913", "msg": "" }' --accountId $username --gas $total_gas --depositYocto 1
